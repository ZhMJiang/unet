...
#======训练网络======
if __TrainNetwork :
    # myGene = trainGenerator(2,'data/membrane/train','image','label',data_gen_args,flag_multi_class = True, num_class = 2, target_size=(512,512),save_to_dir = None)
    myGene = trainGenerator(2, 'data/single_cell_rgb/train', 'image', 'label', data_gen_args, image_color_mode='rgb', save_to_dir = None, flag_multi_class = True, num_class = 2, target_size=(256,256))
...
saveResult("data/single_cell_rgb/test",results,test_name_list,flag_multi_class = True,num_class = 2)